...
test("", function (){
    let dict_ex = {
        ...
        "собой минимум": 1, "таким образом": 1, "образом сбылась": 1, "сбылась мечта": 1, "мечта идиота": 1, "идиота утверждение": 1,
...
test("", function (){
    let dict_ex = {
        ...
        "гегельянство расточительно представляет": 1, "расточительно представляет собой": 1, "представляет собой минимум": 1,
        "таким образом сбылась": 1, "образом сбылась мечта": 1, "сбылась мечта идиота": 1, "мечта идиота утверждение": 1, "идиота утверждение полностью": 1,
